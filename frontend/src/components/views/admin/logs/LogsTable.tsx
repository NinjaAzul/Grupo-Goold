                ...
                <TableRow key={log.id}>
                  <TableCell className="whitespace-nowrap">
                    <div>
                      ...
                      <div className="text-sm text-gray-500">{log.clienteEmail}</div>
                    </div>
                  </TableCell>
                  <TableCell className="whitespace-nowrap">
                    <Badge variant="secondary" className="bg-[#F6F4F1] text-black border-[#D7D7D7]">
                      {log.tipoAtividade}
                    </Badge>
                  </TableCell>
                  <TableCell className="whitespace-nowrap">
                    <Badge variant="secondary" className="bg-[#F6F4F1] text-black border-[#D7D7D7] inline-flex items-center gap-1 w-auto">
